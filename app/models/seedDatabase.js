var ionicjs = {
  ...
  instructors: [{
            ...
            picture: 'modules/assets/images/davy.png',
...
var javascript = {
  ...
  tags: ['javascript', 'mobile application', 'AngularJS'],
  description: 'JavaScrit is the most popular programming language in the world! With it, you can build web applications, desktop (native) applications, server side applications, mobile (hybrid) applications and much more than one can imagine! In these sessions, you will learn how to efficiently use this tool. You will learn by building a library such as underscore.js.',
  level: 'beginner',
  type: 'comingsoon',
...
var gulpjs = {
  ...
  tags: ['javascript', 'NodeJS', 'Automation', 'CI'],
  description: 'Gulp is an automation tool that helps you enhance the workflow of a project! It is easy to use, easy to learn and come with hundreds of plugins that can speed up development process. During this session, you will learn why and how to efficiently use Gulp in an entreprise environment. Come and learn how to build your own Gulpfile.js.',
  level: 'beginner',
  type: 'comingsoon',
...
var meteor = {
  ...
  description: 'Meteor is a complete open source platform to build scalable web and mobile applications in vanilla JavaScrit. Developing with Meteor is a fast and fun experience to explore. During this session, we will build a bookstore, along the way you will learn how to be productive with this framework, how to use it in an entreprise environment and much more...',
  level: 'beginner',
  type: 'comingsoon',
...
var html5 = {
  ...
  description: 'HTML5, who never heard about HTML5? We all use it at some level but do you really know what is behind this technology? During this one week one project, you will dig into the ins and outs of HTML5, its api (video, audio, webrtc, canvas, web components...). We will be building a web application and an hybrid mobile app using HTML5 while learning why and how to efficiently use these technologies.',
  level: 'beginner',
  type: 'comingsoon',
...
var es6 = {
  ...
  description: 'Next generation of JavaScript! ES6 will bring classes, function generators, module system, natively support promise, proxying functions and many more features to JavaScript! The good news is that you can use it right away into your projects, even in an entreprise environment. This one day session will help you embrace these new features today.',
  level: 'intermediaire',
  type: 'comingsoon',
  category: 'Programming Language',
  importantPoints: ['One Session of hacking on Vanilla JavaScript','Open Session: Up to 12 people', 'Philos Methodology: Learn.Build.Share'],
...
var tdd = {
  ...
  shortTitle: 'TDD',
  tags: ['javascript', 'programming language', 'AngularJS'],
  description: 'TDD: Test Driven Developement. Why should you test your code? When should you test your code? Which tools and techniques should you use to test efficiently your code? During this one day one tech, will dig into how testing first can lead to a better design and architecture for your application. By going throught the RED GREEN REFACTOR cycle, you will get more confident building your next application.',
  level: 'beginner',
  type: 'comingsoon',
...
var git = {
  ...
  description: 'Git is an open source distributed version control system designed to handle from small to very large projects with speed and efficiency. It is easy to use but things can get very complicated in a team. Which workflow do you use? What is the difference between rebasing and merging? During these hands-on workshops, you will be able to answer those questions and much more...',
  level: 'beginner',
  type: 'comingsoon',
  ...
  requirements: ['Your laptop', 'Github Account', 'Heroku Account', 'Ionic CLI installed', 'Android and/or iOS phone', 'A smile and a lot of energy'],
  takeAways: ['You can build advanced mobile applications with web technologies', 'Pair programming', 'JavaScript OS: The big picture', 'Write clean and maintenable code', 'Ionic Framework and AngularJS are here to stay'],
  logo: 'modules/assets/images/workshops/TRAININGS-ILLUSTRATIONS-12.png',
  instructors: [{
            firstName: 'Davy',
            lastName: 'Engone',
            company: 'Philos.io',
